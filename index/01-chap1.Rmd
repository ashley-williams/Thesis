...
\begin{center}
  \captionof{figure}[Google Earth image of Dan River and sampling locations.]{Google Earth image of Dan River and sampling sites. Markers indicate sampling sites: Blue, upstream of spill site; Green, leaching site; Yellow, downstream dredged locations; Orange, downstream not dredged.}\label{fig:map}
  \centering
...
read_excel("data/pcrdatasheets.xlsx", sheet = "primers") %>% 
  kable(booktabs=T, caption = "Primers used in this study.", align = "l",linesep = "" ) #%>% landscape()
```
