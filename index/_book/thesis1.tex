...
\caption[P-values of Kruskall-Wallis Test of Growth Rate.]{\label{tab:muvalue}P-values of Kruskall-Wallis Test of Maximal Growth Rate. Bold typeface signifies p-value <0.05. NA: Not Analyzed (Data listed in Appendix)}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}{lllllllll}
\toprule
